	...
	if save.has_section_key(ip, "sbs_mode"):
		...
		if save.has_section_key(ip, "ai_3d_speed"):
			...
			if old_model == 0:
				...
				match old_model:
					1: main.ai_3d_model = 3 # MiDaS-192
					2: main.ai_3d_model = 5 # YOLO26-N-256
					3: main.ai_3d_model = 6 # YOLO26-N-320
					4: main.ai_3d_model = 7 # YOLO26-N-384
					5: main.ai_3d_model = 4 # MiDaS-256
					6: main.ai_3d_model = 0 # MiDaS-256-GPU
					7: main.ai_3d_model = 8 # DA-V2-196
					8: main.ai_3d_model = 9 # DA-V2-252
					_: main.ai_3d_model = 4 # MiDaS-256 (fallback)
